...
var P256Keypair = /** @class */ (function () {
    function P256Keypair(privateKey, exportable) {
        this.privateKey = privateKey;
        this.exportable = exportable;
        this.jwtAlg = const_1.P256_JWT_ALG;
        this.publicKey = p256_1.p256.getPublicKey(privateKey);
    }
    P256Keypair.create = function (opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, exportable, privKey;
            return __generator(this, function (_b) {
                _a = (opts || {}).exportable, exportable = _a === void 0 ? false : _a;
                privKey = p256_1.p256.utils.randomPrivateKey();
                return [2 /*return*/, new P256Keypair(privKey, exportable)];
            });
        });
    };
    P256Keypair.import = function (privKey, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, exportable, privKeyBytes;
            return __generator(this, function (_b) {
                _a = (opts || {}).exportable, exportable = _a === void 0 ? false : _a;
                privKeyBytes = typeof privKey === 'string' ? (0, uint8arrays_1.fromString)(privKey, 'hex') : privKey;
                return [2 /*return*/, new P256Keypair(privKeyBytes, exportable)];
            });
        });
    };
    P256Keypair.prototype.publicKeyBytes = function () {
        return this.publicKey;
    };
    P256Keypair.prototype.publicKeyStr = function (encoding) {
        if (encoding === void 0) { encoding = 'base64pad'; }
        return (0, uint8arrays_1.toString)(this.publicKey, encoding);
    };
    P256Keypair.prototype.did = function () {
        return did.formatDidKey(this.jwtAlg, this.publicKey);
    };
    P256Keypair.prototype.sign = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            var msgHash, sig;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        msgHash = _a.sent();
                        return [4 /*yield*/, p256_1.p256.sign(msgHash, this.privateKey, { lowS: true })];
                    case 2:
                        sig = _a.sent();
    ...
    P256Keypair.prototype.export = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.exportable) {
